...
migrateup:
	migrate -path db/migrations -database "postgresql://root:mCHF7frAgCyhgLkVFJe0@simple-bank.clsi8qk24waz.ap-south-1.rds.amazonaws.com:5432/simple_bank" -verbose up
